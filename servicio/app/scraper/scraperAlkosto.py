...
class ScraperAlkosto():
    def __init__(self, categoria):
        ...
        if self.categoria == "portatiles":
            self.url = "https://www.alkosto.com/computadores-tablet/computadores-portatiles/c/BI_104_ALKOS"
        elif self.categoria == "televisores":
            self.url = "https://www.alkosto.com/tv-video/televisores/c/BI_120_ALKOS"
        elif self.categoria == "smartphones":
            self.url = "https://www.alkosto.com/celulares/telefonos-celulares/c/BI_101_ALKOS"
    ...
    def llenarBD(self):
        try:
            ...
            lista_productos = soup.findAll("li", class_="product__list--item product__list--alkosto js-product-item")
